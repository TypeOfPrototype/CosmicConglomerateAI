# **App Name**: Cosmic Conglomerate

## Core Features:

- Game Simulation: Simulate the Space Monopoly game with configurable board size, number of players, and turn limits.
- Interactive Board Display: Visually represent the game board, companies, player stats (cash, stock), and game state.
- Game Logic Engine: Implement core game mechanics: tile placement, company formation/expansion, stock market, and merger resolution as described in the provided rules.
- Merger Prediction: Implement an AI tool to predict the outcome of mergers based on current company sizes and stock holdings.
- Player Controls & Information: Provide intuitive UI elements for stock purchase/sale, displaying merger outcomes, and game status.
- AI Players: Allow for the inclusion of AI players in the game.

## Style Guidelines:

- Primary color: Dark blue (#001F3F) to evoke a sense of deep space.
- Secondary color: Light gray (#D3D3D3) for UI elements and text to ensure readability.
- Accent: Teal (#008080) for interactive elements and highlights.
- Clean, modern sans-serif typography for a futuristic aesthetic.
- Use space-themed icons for companies, resources, and actions.
- Grid-based layout to mirror the board game, with clear divisions for player information and controls.
